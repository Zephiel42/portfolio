...
const T = {
    en: {
        ...
        skills: [
            {
                label: "Languages",
                tags: ["Python", "TypeScript", "Go", "C / C++", "SQL", "Java"],
            },
            {
                label: "Web / Infra",
                tags: [
        ...
        proj: [
            {
                name: "Multilingual NLU",
                desc: "Zero-shot intent detection & slot filling — English → French, no French training data. GRU / Transformer / XLM-RoBERTa.",
            },
            {
                name: "Cyber Audit",
                desc: "Full pentest on HackTheBox (SSTI → credential dump → pickle RCE → root via GPG brute-force).",
            },
            {
                name: "3D Portfolio",
                desc: "Interactive Three.js portfolio with mini-game, i18n, containerised backend (FastAPI + PostgreSQL + Nginx).",
            },
            {
                name: "3D Space Game",
                desc: "Real-time multiplayer game — Three.js / WebGL, Go backend, WebSockets + Protobuf, Docker Compose.",
            },
            {
                name: "Dominion (C++)",
                desc: "Full recreation of the card game with OpenGL UI built from scratch, MiniAudio, custom components.",
            },
            {
                name: "Eco App",
                desc: "Ecological impact tracking application.",
            },
        ],
        langTitle: "Languages",
        langs: [
    ...
    fr: {
        ...
        proj: [
            {
                name: "NLU multilingue",
                desc: "Détection d'intention & remplissage de slots en zero-shot (anglais → français sans données FR). GRU / Transformer / XLM-RoBERTa.",
            },
            {
                name: "Audit Cyber",
                desc: "Pentest complet sur HackTheBox (SSTI → dump credentials → RCE pickle → root via brute-force GPG).",
            },
            {
                name: "Portfolio 3D",
                desc: "Portfolio interactif Three.js avec mini-jeu, i18n, backend conteneurisé (FastAPI + PostgreSQL + Nginx).",
            },
            {
                name: "Jeu spatial 3D",
                desc: "Jeu multijoueur temps réel — Three.js / WebGL, backend Go, WebSockets + Protobuf, Docker Compose.",
            },
            {
                name: "Dominion (C++)",
                desc: "Recréation complète du jeu de cartes avec UI OpenGL from scratch, MiniAudio, composants sur mesure.",
            },
            {
                name: "Éco App",
                desc: "Application de suivi d'impact écologique.",
            },
        ],
        langTitle: "Langues",
        langs: [
